...
export const useTyper = () => {
    const text1="Can you give me the BSR keyword under category \"computer monitor\" at Amazon? I need Top5 BSR keyword for past 6 months' data, draw me a graph of \"Line Charts\", y-axis=Monthly Sales, x-axis=time"
